    ...
    <div className="px-4 md:px-8 py-6 space-y-6">
      <div>
        ...
        <p className="text-body-md" style={{ color: '#859490' }}>
          Private family wiki for preserving knowledge, guides, and important information
        </p>
      </div>
      ...
      <div className="glass-card rounded-2xl p-8 text-center">
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #0566d9, #adc6ff)' }}
        >
          <span
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-3 max-w-lg mx-auto">
          {features.map((f) => (
            ...
            >
              <span
                className="material-symbols-outlined"
                style={{ fontSize: '16px', color: '#adc6ff' }}
              >
                check_circle
              </span>
