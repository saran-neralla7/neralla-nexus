    ...
    <div className="px-4 md:px-8 py-6 space-y-6">
      <div>
        <div className="flex items-center gap-3 mb-2">
          <span
            ...
            style={{ color: '#ffb4ab', fontSize: '28px', fontVariationSettings: "'FILL' 1" }}
          >
            sos
          </span>
          <h1
        ...
        <p className="text-body-md" style={{ color: '#859490' }}>
          Critical information accessible instantly during emergencies
        </p>
      </div>
      ...
      <div className="glass-card rounded-2xl p-8 text-center">
        <div
          ...
          style={{ background: 'linear-gradient(135deg, #93000a, #ffb4ab)' }}
        >
          <span
        ...
        <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-3 max-w-lg mx-auto">
          {features.map((f) => (
            ...
            >
              <span
                className="material-symbols-outlined"
                style={{ fontSize: '16px', color: '#ffb4ab' }}
              >
                check_circle
              </span>
